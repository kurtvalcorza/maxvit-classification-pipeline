...
The upstream snapshot is pinned to `041f2cce4d74c7539d63aa9fb85786e78072d487` and the notebook is regenerated with that revision and manifest, so it can run; no execution is recorded yet.
