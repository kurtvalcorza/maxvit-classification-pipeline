...
EXPECTED_MODEL_ID = "timm/maxvit_tiny_tf_224.in1k"
...
EXPECTED_OUTPUTS = (
    "maxvit_classification_input_manifest.json",
    "maxvit_classification_evaluation_report.json",
    "maxvit_classification_result.json",
    "maxvit_classification_predictions.csv",
    "maxvit_adapter.safetensors",
)
